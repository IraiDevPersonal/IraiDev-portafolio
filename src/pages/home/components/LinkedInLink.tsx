...
export function LinkeIn() {
   return (
      <a
         title="Descargar CURRICULUM VITAE"
         className="text-slate-400 h-9 w-9 grid place-content-center sm:block sm:h-auto sm:w-auto sm:py-1.5 sm:px-3 rounded-full overflow-hidden group relative border-2 border-slate-700 hover:border-blue-600 hover:text-white"
